...
public class MyAppWidgetProvider extends AppWidgetProvider {
    ...
    public void onUpdate(Context context, AppWidgetManager appWidgetManager, int[] appWidgetIds) {
        MyJobIntentService.enqueueWork(context, MyJobIntentService.CREATE_WIDGETS_ACTION, appWidgetIds);
    }

    // Called after an app widget is resized
    @Override
    public void onAppWidgetOptionsChanged(Context context, AppWidgetManager appWidgetManager, int appWidgetId, Bundle newOptions) {
        MyJobIntentService.enqueueWork(context, MyJobIntentService.RESIZE_WIDGET_ACTION, new int[]{appWidgetId});
    }
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        switch (IntentUtils.requireAction(intent)) {
            case SHOW_NEXT_RECIPE_ACTION:
                ...
                MyJobIntentService.enqueueWork(context, MyJobIntentService.SHOW_NEXT_RECIPE_WIDGET_ACTION, new int[]{appWidgetId});
                break;
        }
    }
}