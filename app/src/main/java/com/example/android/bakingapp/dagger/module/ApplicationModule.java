...
public class ApplicationModule {
    ...
    static Gson provideGson() {
        return new GsonBuilder().registerTypeAdapter(new TypeToken<List<Recipe>>() {}.getType(), (JsonDeserializer<List<Recipe>>) (json, type, context1)
    ...
    @Singleton
    @Provides
    static RecipeService provideRecipeService(Gson gson, String recipesBaseUrl) {
